...
def main():
    ...
    print("Copy that file to ~/.cursor/mcp.json (or merge its mcpServers into your existing ~/.cursor/mcp.json).")
    print("Server must be running (e.g. bash scripts/run_mcp_http.sh). Override URL: DOC_RAG_MCP_URL=...")
    print()
